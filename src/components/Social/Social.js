  ...
  if (mobile) {
    return (
      <div className={classes.mobileWrapper}>
        <IconBtn icon={GitHub} m={1} href="https://github.com/nomekop007" />
        <IconBtn
          icon={Instagram}
          m={1}
          href="https://www.instagram.com/dieg0_rios/"
        />
        <IconBtn
          icon={LinkedIn}
          m={1}
          href="https://www.linkedin.com/in/diegoriosfullstackjs"
        />
    ...
    return (
      <motion.div className={classes.wrapper}>
        ...
        <motion.div animate={controls} custom={3}>
          <IconBtn icon={Email} m={1} href="mailto:d.riosrojas007@gmail.com" />
        </motion.div>
